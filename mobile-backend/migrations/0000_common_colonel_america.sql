...
CREATE TABLE IF NOT EXISTS "programs" (
	...
	"program_file_url" varchar(500),
	"program_file_type" varchar(20),
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "nutrition_plans" ADD CONSTRAINT "nutrition_plans_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "program_sessions" ADD CONSTRAINT "program_sessions_program_id_programs_id_fk" FOREIGN KEY ("program_id") REFERENCES "public"."programs"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "nutrition_plans_user_status_idx" ON "nutrition_plans" ("user_id","status");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "planned_workouts_plan_date_idx" ON "planned_workouts" ("plan_id","date");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "program_sessions_program_day_idx" ON "program_sessions" ("program_id","day_number");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "programs_user_status_idx" ON "programs" ("user_id","status");--> statement-breakpoint
